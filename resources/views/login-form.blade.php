        ...
        <div class="col-md-5">
            <div class="card login-card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('auth.login') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">Min. 3 karakter, harus mengandung huruf kapital.</div>
                        </div>
                        <div class="d-grid">
                ...
                <div class="card-footer">
                    <p class="small-text">Don't have an account? <a href="{{ route('show.signup.form') }}">Sign up</a></p>
                </div>
            </div>
        </div>
    </div>
